...
class TemplateTagSidebarMenuTestCase(TemplateTagSidebarMenuBaseTestCase):
    ...
    @override_settings(ROOT_URLCONF="tests.django_adminlte2_pdq.django_test_project.urls_empty")
    ...
    def test__get_permissions_from_node__standard(self):
        ...
        with self.subTest("Route is a hash"):
            ...
            self.assertFalse(allow_anonymous_access)
    ...
    def test__render_types(self):
        ...
        with self.subTest("Render link - Dynamic text via string"):
            ...
            node = {
                "route": "adminlte2_pdq:sample2",
                "text": "Sample2",
                "hook": "tests.django_adminlte2_pdq.django_test_project.utils.valid_string_hook_function",
                "hook_args": ["foo"],
        ...
        with self.subTest("Render link - Dynamic text via tuple"):
            ...
            node = {
                "route": "adminlte2_pdq:sample2",
                "text": "Sample2",
                "hook": "tests.django_adminlte2_pdq.django_test_project.utils.valid_tuple_hook_function",
                "hook_args": ["foo"],
                "hook_kwargs": {"kwarg1": "bar"},
            }
...
class TemplateTagSidebarMenu_IsAllowedNodeTestCase(TemplateTagSidebarMenuBaseTestCase):  # pylint:disable=invalid-name
    ...
    def test__login_required__no_whitelists__node_allow_anonymous_access(self):
        ...
        with self.subTest("As anonymous user"):
            # Note: See above note for allow_anonymous_access test with anonymous user.
    ...
    # @patch("adminlte2_pdq.templatetags.sidebar_menu.STRICT_POLICY", True)
    # @patch("adminlte2_pdq.templatetags.sidebar_menu.LOGIN_EXEMPT_WHITELIST", ["adminlte2_pdq:demo-css"])
    # def test__strict__with_login_whitelist__node_allow_anonymous_access(self):
    #     """"""
    #
    #     # Node used for all subtests.
    #     node = {
